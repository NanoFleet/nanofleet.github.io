...
| Discord | `ghcr.io/nanofleet/nanofleet-channel-discord:latest` |
| Webhook | `ghcr.io/nanofleet/nanofleet-channel-webhook:latest` |
| CLI | Built into the agent (`/cli` endpoint) |
